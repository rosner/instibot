...
public class Lists {
     ...
     * @param list1
     * @param list2
     * @return a new list that combines the elements of <code>list1</code> and
     *         <code>list2</code>
     */
    ...
    /**
     * Produces a new list that combines a single element and the elements of a
     * list.
     * 
     * @param <T>
     * @param item
     ...
     * @param <T>
     * @param list
     * @return a list of lists encompassing all permutations of
     *         <code>list</code>
     */
     ...
     * @param list
     * @param quote
     *            whether or not the items in the list should be quoted (do not
     *            quote if items are themselves regexps)
    ...
    /**
     * Compares two lists of equal type, by returning a number composed of the
     * sum of all differences of all non-overlapping members of the two lists.
     * 
     * @param <T>
     * @param oneList
     * @param anotherList
     ...
     */
    public static <T extends Comparable<?>> int compare(List<T> oneList,
	    List<T> anotherList) {
	return compareOneWay(oneList, anotherList)
		+ compareOneWay(anotherList, oneList);
    }

    /**
     * Compares two lists of equal type in one direction only (checking the
     * items from the second list that do not occur in the first).
     * 
     * @param <T>
     * @param oneList
     * @param anotherList
     * @return the comparison between the items of the second list that do not
     *         appear in the first, and null
     */
    private static <T extends Comparable<?>> int compareOneWay(List<T> oneList,
	    List<T> anotherList) {
	int result = 0;
