...
abstract public class CoreSettings extends Settings {
    ...
    /**
     * The number of predicate set operations before flushing predicates to
     * storage.
     */
    ...
    /**
     * The directory in which to save flat-file predicates (if the
     * FlatFilePredicateManager is used).
     */
	...
	/**
	 * Store the new template as well, so it will have an equal chance of
	 * being used as the currently loaded one.
	 */
	COMBINE
    }
    ...
    /**
     * @param value
     *            the value for AIMLNamespaceURI
     */
    ...
    /**
     * @param value
     *            the value for predicateEmptyDefault
     */
    ...
    /**
     * @param value
     *            the value for clientNamePredicate
     */
    ...
    /**
     * @param value
     *            the value for predicateFlushPeriod
     */
    ...
    /**
     * @param value
     *            the value for predicateManagerImplementation
     */
    ...
    /**
     * @param value
     *            the value for databaseMaximumConnections
     */
    ...
    /**
     * @param value
     *            the value for databaseUsername
     */
    ...
    /**
     * @param value
     *            the value for databasePassword
     */
    ...
    /**
     * @param value
     *            the value for appendMergeSeparatorString
     */
    ...
    /**
     * @param value
     *            the value for infiniteLoopInput
     */
    ...
    /**
     * @param value
     *            the value for printStackTraceOnUncaughtExceptions
     */
    ...
    /**
     * @param value
     *            the value for pulseImplementation
     */
    ...
    /**
     * @param value
     *            the value for AIMLWatcherTimer
     */
    ...
    /**
     * @param value
     *            the value for javascriptInterpreterClassname
     */
    ...
    /**
     * @param value
     *            the value for systemInterpreterDirectory
     */
    ...
    /**
     * @param value
     *            the value for systemInterpreterPrefix
     */
    ...
    /**
     * @param value
     *            the value for categoryLoadNotificationInterval
     */
    ...
    /**
     * @param value
     *            the value for noteEachLoadedFile
     */
    ...
    /**
     * @param value
     *            the value for exitImmediatelyOnStartup
     */
    ...
    /**
     * @param value
     *            the value for graphmapperImplementation
     */
    ...
    /**
     * @param value
     *            the value for nodemapperImplementation
     */
    ...
    /**
     * @param value
     *            the value for xmlParserUseEntityResolver2
     */
    ...
    /**
     * @param value
     *            the value for xmlParserUseValidation
     */
    ...
    /**
     * @param value
     *            the value for xmlParserUseSchemaValidation
     */
    ...
    /**
     * @param value
     *            the value for xmlParserHonourAllSchemaLocations
     */
    ...
    /**
     * @param value
     *            the value for xmlParserUseXInclude
     */
    ...
    /**
     * @param value
     *            the value for xmlParserValidateAnnotations
     */
