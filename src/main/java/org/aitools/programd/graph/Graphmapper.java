...
/**
 * A <code>Graphmapper</code> is responsible for managing categories. It can
 * {@link #addCategory add} categories, {@link #removeCategory remove}
 * categories, or {@link #match} categories. The interface is implementation-
 * independent. There is a memory-based implementation in
 * {@link MemoryGraphmapper}, which loads categories and builds a tree in
 * memory. There is also a database-based implementation in DBGraphmapper, which
...
public interface Graphmapper {
    /**
     * Loads the <code>Graphmapper</code> with the AIML file to be found at
     * <code>path</code>.
     * 
     * @param path
     ...
     * 
     * @param pattern
     *            the category's <code>pattern</code>
     * @param that
     *            the category's <code>that</code>
     * @param topic
     *            the category's <code>topic</code>
     * @param template
     *            the category's <code>template</code>
     * @param bot
    ...
    /**
     * Removes all categories associated with a given filename, and removes the
     * file from the list of loaded files.
     * 
     * @param path
     *            the filename
     * @param bot
     ...
     *            the category's <code>topic</code>
     * @param bot
     *            the bot for whom the category is being removed
     */
     ...
     * 
     * @param path
     *            the filename to which to print
     */
