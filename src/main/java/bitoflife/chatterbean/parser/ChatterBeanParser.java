...
public class ChatterBeanParser {
     ...
     */
    /*
     * private Logger newLogger(String root, String dir) throws Exception { if
     * (dir == null) return null; String path = root + dir;
     * 
     * Sequence sequence = new Sequence(path + "sequence.txt"); File file = new
     * File(path + "log" + sequence.getNext() + ".txt"); return
     * loggerClass.getConstructor(Writer.class).newInstance(new
     * FileWriter(file)); }
     */
